...
if __name__ == '__main__':
    ...
    p4instance = config['p4']['p4instance']
    ...
    if options.command == 'restorevol':
        ...
        if inp == 'Y':  
            runoscommand('sudo umount ' + db1fs)
            time.sleep(1)
        elif inp == 'N':
            exit()
        
        print('\nVerify  p4db1 mount')
        runoscommand('sudo df -h ' + db1fs)
        #time.sleep(1)
        # #step 3
        ...
        print('Starting p4d')
        runoscommand('sudo systemctl start ' + p4instance)
        time.sleep(2)
        runoscommand('sudo systemctl status ' + p4instance)
